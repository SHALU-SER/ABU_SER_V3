...
module.exports = {
    ...
    ALIVEBTN: process.env.ALIVE_BUTTON === undefined ? 'ᴇɴɢᴀɴᴇʏᴜɴᴅ ᴀʙᴜsᴇ🌝' : process.env.ALIVE_BUTTON,
    ALIVEBTN2: process.env.ALIVE_BUTTON2 === undefined ? 'POWEREESH🤩' : process.env.ALIVE_BUTTON2,
    ...
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://i.ibb.co/TcDLWQg/IMG-20220106-WA0000.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ABU_SER_V3' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ 💝 ABU_SER_V3 💝 ‒‒‒⊣' : process.env.BOT_NAME,
    BOTSK: process.env.BOT_NAME === undefined ? 'Maalutty' : process.env.BOT_NAME,
    ...
    ALLEMOJI: process.env.CMD_LIST === undefined ? 'MAALUTTY💞/💝/✨/📝' : process.env.CMD_LIST,
